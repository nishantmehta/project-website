<#-- @ftlvariable name="" type="com.nishant.web.resource.view.HomePage" -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--===============================================================================================-->
	...
	<script>
		$('.cd100').countdown100({
			...
			endtimeYear: 0,
			endtimeMonth: 0,
			endtimeDate: ${pendingTime.days},
			endtimeHours: ${pendingTime.hours},
			endtimeMinutes: ${pendingTime.minutes},
			endtimeSeconds: 0,
			timeZone: ""
